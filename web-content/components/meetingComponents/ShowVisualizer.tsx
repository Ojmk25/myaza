import { MeetingManager, RosterAttendeeType } from "amazon-chime-sdk-component-library-react";
...
const ShowVisualizer = ({ attendee, meetingManager }: { attendee: RosterAttendeeType, meetingManager: MeetingManager }) => {
  ...
  const audioVisualizer = (
    <>
      {
        audioState.mute ? (
          <div className=" flex justify-center items-end p-[6px] bg-[#333333] rounded-full  w-[30px] h-[30px]">
