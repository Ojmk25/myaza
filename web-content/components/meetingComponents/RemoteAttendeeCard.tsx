      ...
      <div className="flex-1 flex justify-center items-center">
        <div className=" w-full h-full" >
          ...
          {videoTildId === undefined ? (
            ...
            <RemoteVideo tileId={videoTildId} className=' rounded relative bg-slate-800 [transform:rotateY(180deg)]' id={`remotevideo-${videoTildId}`} key={videoTildId} name={processString(name as string)} />
          ...
          <div className=" flex w-full h-full justify-center items-center @container/imageWrapper">
            <div>
              {!videoEnabled &&
                ...
                <div className=" bg-cs-grey-800 @[150px]/imageWrapper:w-[80px] @[150px]/imageWrapper:h-[80px] @[600px]/imageWrapper:w-[150px] @[600px]/imageWrapper:h-[150px] rounded-full flex justify-center items-center text-cs-grey-55 font-semibold text-[28px] m-auto">{getRemoteInitials(name as string)}</div>
              }
