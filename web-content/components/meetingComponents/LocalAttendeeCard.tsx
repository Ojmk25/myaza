...
export const LocalAttendeeCard = ({ name, attendeeId, videoTildId, nameID, audioState }: { name: string | undefined, attendeeId: any, videoTildId: number, nameID: string, audioState: JSX.Element }) => {
    ...
    <div className={`wrapperDiv bg-cs-black-200 flex-1 ${isVideoEnabled ? "" : "p-4"} rounded flex flex-col relative overflow-hidden`}>
      ...
      <div className="flex-1 flex justify-center items-center">
        <div className=" min-h-[200px] w-full h-full" >
          {!isVideoEnabled && (
            <Image src={avatar} alt="" className=" max-w-[297px] max-h-[297px] rounded-full m-auto" />
          )}
