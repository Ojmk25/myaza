...
export default function MeetingPage({
  ...
  const transcriptionPayload = {
    ...
    attendee_id: meetingManager.meetingSessionConfiguration?.credentials
      ...
      <div className="max-auto w-full ">
        <main className=" flex flex-col md:px-6 h-dvh w-full relative meetingScreen overflow-hidden">
          ...
          <MeetingControl
            ...
            startTranscriptionProp={handleStartTranscription}
            stopTranscriptionProp={handleStopTranscription}
            transcriptionStatus={isCaption}
          />
