...
export default function Header() {
  ...
  return (
    <>
     ...
     <div
        className=" w-fit fixed bottom-10 right-4 z-50 text-white flex items-center gap-4"
      ...
      >
        ...
        <div  ref={widgetRef} className="bg-cs-purple-650 text-cs-grey-60-light p-[10px] rounded-lg font-semibold flex items-center md:gap-x-2 cursor-pointer">
