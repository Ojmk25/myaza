...
export default function AuthLayout({
  ...
  return (
    ...
    <main className=" py-8  relative bg-cs-grey-60-light min-h-dvh px-6">
      <h1 className=" text-2xl lg:text-3xl text-cs-purple-650 font-bold text-center">CecureStream</h1>
      ...
      <Image src={userBg} alt="bg" className="absolute top-[110px] left-[24%] sm:left-[-30px] md:left-[35px] lg:left-[18%] xl:left-[23%] w-[220px] h-[220px]" />
      <Image src={crabBg} alt="bg" className="absolute top-[250px] right-[25.9%] sm:right-[1px] md:right-[40px] lg:right-[20%] xl:right-[25%] w-[220px] h-[220px]" />
    </main >
  );
}