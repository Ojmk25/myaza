export default function RecordingConsentFailedModal({
  onClose,
}: {
  onClose: () => void;
}) {
        ...
        <div className="flex items-center justify-center min-h-screen px-2">
          ...
          <div className="inline-block align-bottom transition-all transform  bg-[#FFFFFA] rounded-lg shadow-xl sm:align-middle sm:w-full sm:max-w-[525px] border-cs-grey-300 border-solid border p-6">
            ...
            <p className=" text-[#333333] font-medium text-sm metro-medium">
              An error occurred while starting recording
            </p>

            <div className="flex md:justify-end pt-6">
              <button
                className="bg-cs-purple-650  text-cs-grey-50 py-3 px-4 rounded-[10px] w-full md:w-36 hover:bg-cs-purple-650/80 font-bold text-sm metro-medium"
                onClick={onClose}
              >
                Back to meeting
              </button>
