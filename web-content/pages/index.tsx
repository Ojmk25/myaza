...
import { ValidateLink, extractAfterLastSlashOrFull, isValidUUID } from "../utils/Validators";
...
import { IsAuthenticated, getNameAbbreviation, logOutUser } from "@/services/authService";
          ...
          <div className="flex flex-col md:flex-row gap-y-6 justify-between mt-4 md:mt-8 relative">
            ...
            <div>
              ...
              <div className={`flex border ${errorColour ? "border-cs-error-600" : " border-cs-grey-55"}  rounded-md py-1 pr-1 pl-3 border-solid h-12`}>
                ...
                <button className=" text-cs-purple-650 font-bold py-0 md:py-1 px-6 border border-cs-purple-650 rounded hover:text-white hover:bg-cs-purple-650" onClick={() => joinMeeting(linkData)} disabled={disableButton}>Join</button>
              </div>
