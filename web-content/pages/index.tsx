    ...
    <>
      {loggedIn !== null && (
        <main className="lg:pb-20 pt-6 lg:pt-10 w-full flex items-center flex-col ">
          ...
          <div className="block lg:grid px-6 gap-x-16 items-center grid-cols-2 mt-2 bg-cs-bg max-auto w-full max-w-[1280px]">
            <div className="basis-full">
              ...
              <p className=" text-cs-grey-100 text-lg text-center lg:text-left md:text-2xl mt-4">
                With our secure video conferencing service, you can connect with
                your team with ease.
              </p>
              <div
